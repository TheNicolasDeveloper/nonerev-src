...
//    public static function getIPnPort($ip, $port)
//    {
//        global $pdo;
//        $stmt = $pdo->prepare("SELECT * FROM games WHERE ip = :ip");
//        $stmt->bindValue(":ip", $ip, PDO::PARAM_INT);
//        $stmt->execute();
//        $stmt2 = $pdo->prepare("SELECT * FROM games WHERE port = :port");
//        $stmt2->bindValue(":port", $port, PDO::PARAM_INT);
//        $stmt2->execute();
//        return $stmt->fetch();
//    }

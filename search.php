...
<div class="container">
    ...
    <div class="<?= $searchType === "game" ? "games-search-list gap-2 flex-wrap d-flex bg-white rounded" : "row" ?>">
            ...
            <?php foreach ($games as $game) { ?>
                <div class="game-search-item p-3 m-0 position-relative text-body text-decoration-none" style="max-width: 180px;">
                    <div data-testid="game-tile">
                        <a class="game-card-link" href="/game?id=<?= htmlspecialchars($game["id"]) ?>">
                            ...
                            <div class="game-card-name game-name-title" title="<?= $game["title"] ?>"><?= htmlspecialchars($game["title"]) ?></div>
